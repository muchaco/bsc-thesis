...
%=======================================================
    ...
    %=======================================================
		...
		\section{Komplex eset}
			...
			\begin{figure}[ht]
				\subfigure[$-\nabla|f(z)|$ és négy iterációs lépés az $1-0,\!5i$-ből]{\includegraphics[scale=0.5]{kepek/kep7.png} \label{k7}}
				\hfill
				\subfigure[$g(x,y)$ és négy iterációs lépés az $1-0,\!5i$-ből]{\includegraphics[scale=0.5]{kepek/kep4.png}}
...
Mivel a Newton-módszer kiszámíthatatlanul viselkedik a polinom deriváltja gyökeinek a közelében, semmi biztosíték nincs arra, hogy a kezdőponthoz legközelebbi gyökhöz konvergál. Így míg a \ref{Cayley}. tétel alapján erre az általánosításra számíthatnánk, a \ref{GL}. tétel következményeként előfordulhat, hogy az egyik gyökhöz közel elhelyezkedő derivált gyöke, az egyik iterációs lépés során átsodorja a módszert egy másik gyökhöz közelebb.
			...
			\begin{figure}[ht]
				...
				{%
					...
					\fbox{\includegraphics[scale=0.35]{kepek/fractal.png}}
				}%
			...
			\begin{figure}[ht]
				\begin{center}
				\subfigure[{Az $f(x) = (x-1)(x+0,\!5+0,\!33i) (x+0,\!5-0,\!33i)$ polinom a $\{a+bi:a,b\in[-0,\!2;0,\!2]\} $ halmazon.}]{
					\setlength{\fboxsep}{0pt}%
					\setlength{\fboxrule}{1pt}%
					\fbox{\includegraphics[scale=0.45]{kepek/frac1.png}}
				}
				\hspace{1cm}
				\subfigure[{Az $f(x) = x^3-2x+2$ polinom a $\{a+bi:a,b\in[-0,\!3;0,\!3]\} $ halmazon.}]{
					\setlength{\fboxsep}{0pt}%
					\setlength{\fboxrule}{1pt}%
					\fbox{\includegraphics[scale=0.45]{kepek/frac2.png}}
				}
...
\chapter{Módosított módszer polinomokra}
    ...
    %=======================================================
		...
		\section{Motiváció}
			...
			\begin{figure}[ht]
				\subfigure[Egy polinom és a módosított egyenlete]{\includegraphics[scale=0.5]{kepek/sage8.png} \label{k8}}
				\hfill
				\subfigure[Megfelelő intervallumok a kezdőpont választáshoz \ref{t1}. tétel alapján]{\includegraphics[scale=0.5]{kepek/sage9.png} \label{k9}}
				\caption{}
			\end{figure}
    ...
    %=======================================================
		...
		\section{A módszer}
            ...
            \begin{Pl}
				...
				\begin{figure}[h]
					\centering
					\subfigure[Az első iterációs lépéssel lépünk]{\includegraphics[scale=0.75]{kepek/0.png}}
					\hspace{3mm} % két kép közötti távolság
					\subfigure[Az első iterációs lépéssel lépünk]{\includegraphics[scale=0.75]{kepek/1.png}}\\
					\subfigure[Az második iterációs lépéssel lépünk]{\includegraphics[scale=0.75]{kepek/2.png}}
					\hspace{3mm} % két kép közötti távolság
					\subfigure[Az első iterációs lépéssel lépünk]{\includegraphics[scale=0.75]{kepek/3.png}}
				\end{figure}
...
IteracioAbraKomplex(poly([1,3,5+j]),0,5+5j,100,100,3)
                ...
                Ábrázoljunk a $p(x)=(x-1)(x-3)(x-5-i)$ polinomot a $\{a+bi : a,b\in [0,5]\}$ síkrészen, ahol a második iterációs lépés egy nagyobb ponthalmazon divergens, és nézzük meg ugyanitt a véletlen iteráció 100 futtatásából a sikeres iterációk számát és a szükséges lépések számának átlagát. (\ref{atcsuszokep}. ábra)
                			\begin{figure}[h]
					\centering
					\subfigure[Az második iterációs lépéssel]{\includegraphics[scale=0.7]{kepek/erdekes2.png}}
					\subfigure[A véletlen iterációval]{\includegraphics[scale=0.7]{kepek/erdekes3.png}}
...
IteracioAbraKomplex(p,-5-5i,5+5i,100,1,2)
                ...
                Lefuttatjuk a már ismert programunkat amely kirajzolja a szükséges iterációs lépések számát az adott módszerekhez a $\{a+bi:a,b\in[-5,5]\}$ síkrészen.
                           \begin{figure}[hp]
					\centering
					\subfigure[Az első iterációs lépéssel]{\includegraphics[scale=0.6]{kepek/ellenpelda2.png}}
					\subfigure[A második iterációs lépéssel]{\includegraphics[scale=0.6]{kepek/ellenpelda1.png}}
...
% irodalomjegyzék
	...
	\bibitem{vk} Veress Krisztián, \emph{A Newton és Gauss-Newton módszerek alkalmazása egyenletrendszerek megoldására és nemlineáris optimalizálásra} [online], 2007, [2013.05.18.], <http://www.inf.u-szeged.hu/\textasciitilde verkri/bin/newton-gauss.pdf>
