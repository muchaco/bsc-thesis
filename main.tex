...
%=======================================================
    ...
    %=======================================================
		...
		\section{A módszer leírása}
			...
			\begin{Pl}
				...
				$f(x)=0$ egyenletnek gyöke az $x^*=-2.5$. Induljunk el az $x_0=-1$ pontból.\todoor{Változás: Átalakítottam a táblázatot, mert a 3. fejezetben egy példa nem fért el vízszintesen, és szeretném, ha egységes lenne a példák kinézete}
                \begin{center}				
    ...
    %=======================================================
		...
		\section{Konvergencia vizsgálat}
			...
			\end{Tet}
			\begin{Biz}
				Írjuk fel $f$ $x_k$ körüli másodfokú polinomját Lagrange maradéktaggal az $x^*$ pontban 
                \todoor{Változás: átírtam az első mondatot} 
				\begin{eqnarray}
            ...
            \todoor{Változás: Ezt újonnan írtam bele} A másodrendű konvergencia azt jelenti, hogy a hiba legalább négyzetesen csökken, vagyis a helyes jegyek száma nagyjából megduplázódik a lépésenként.
