...
Mivel a Newton-módszer kiszámíthatatlanul viselkedik a polinom deriváltja gyökeinek a közelében, semmi biztosíték nincs arra, hogy a kezdőponthoz legközelebbi gyökhöz konvergál. Így míg a \ref{Cayley}. tétel alapján erre az általánosításra számíthatnánk, a \ref{GL}. tétel következményeként előfordulhat, hogy az egyik gyökhöz közel elhelyezkedő derivált gyöke, az egyik iterációs lépés során átsodorja a módszert egy másik gyökhöz közelebb. 
			...
			\begin{figure}[ht]
				...
				\subfigure[{Az $f(x) = (x-1)(x+0,\!5+0,\!33i) (x+0,\!5-0,\!33i)$ polinom a $\{a+bi:a,b\in[-0,\!2;0,\!2]\} $ halmazon.}]{
					\setlength{\fboxsep}{0pt}%
					\setlength{\fboxrule}{1pt}%
					\fbox{\includegraphics[scale=0.45]{frac1.png}}
				}
				\hspace{1cm}
				\subfigure[{Az $f(x) = x^3-2x+2$ polinom a $\{a+bi:a,b\in[-0,\!3;0,\!3]\} $ halmazon.}]{
					\setlength{\fboxsep}{0pt}%
					\setlength{\fboxrule}{1pt}%
					\fbox{\includegraphics[scale=0.45]{frac2.png}}
				}
    ...
    %=======================================================
		...
		\section{A módszer}
            ...
            \begin{Pl}
				...
				\begin{figure}[h]
					\centering
					\subfigure[Az első iterációs lépéssel lépünk]{\includegraphics[scale=0.75]{0.png}}
					\hspace{3mm} % két kép közötti távolság
					\subfigure[Az első iterációs lépéssel lépünk]{\includegraphics[scale=0.75]{1.png}}\\
					\subfigure[Az második iterációs lépéssel lépünk]{\includegraphics[scale=0.75]{2.png}}
					\hspace{3mm} % két kép közötti távolság
					\subfigure[Az első iterációs lépéssel lépünk]{\includegraphics[scale=0.75]{3.png}}
				\end{figure}
...
IteracioAbraKomplex(p,-5-5i,5+5i,100,1,2)
                ...
                Lefuttatjuk a már ismert programunkat amely kirajzolja a szükséges iterációs lépések számát az adott módszerekhez a $\{a+bi:a,b\in[-5,5]\}$ síkrészen.
                           \begin{figure}[hp]
					\centering
					\subfigure[Az első iterációs lépéssel]{\includegraphics[scale=0.6]{ellenpelda2.png}}
					\subfigure[A második iterációs lépéssel]{\includegraphics[scale=0.6]{ellenpelda1.png}}
